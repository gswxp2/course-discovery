...
class PersonViewSetTests(SerializationMixin, APITestCase):
    ...
    def test_update(self):
        ...
        # Test that defined titles are shown
        assert 'Hopkins new Twitter' == updated_person.person_networks.get(type='twitter', title='Hopkins new Twitter').display_title
    ...
    def test_options_org_choices(self):
        ...
        assert data['position']['children']['organization']['choices'] == [{'display_name': 'aaa', 'value': org2.id}, {'display_name': 'bbb: Test', 'value': self.organization.id}]
