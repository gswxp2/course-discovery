...
class CourseRunWithProgramsSerializerTests(TestCase):
    ...
    def test_include_unpublished_programs(self):
        ...
        serializer = CourseRunWithProgramsSerializer(self.course_run, context=self.serializer_context)
        assert serializer.data['programs'] == NestedProgramSerializer([unpublished_program], many=True, context=self.serializer_context).data
    ...
    def test_include_retired_programs(self):
        ...
        serializer = CourseRunWithProgramsSerializer(self.course_run, context=self.serializer_context)
        assert serializer.data['programs'] == NestedProgramSerializer([retired_program], many=True, context=self.serializer_context).data
