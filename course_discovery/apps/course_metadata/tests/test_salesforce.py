    ...
    def test_get_comments_for_course_case_id_set(self):
        ...
        with mock.patch(self.salesforce_path):
            with mock.patch(query_path, return_value=return_value) as mock_query:
                ...
                assert comments == [{'user': {'username': user.username, 'email': user.email, 'first_name': user.first_name, 'last_name': user.last_name}, 'course_run_key': 'course-v1:testX+TestX+Test', 'comment': 'This is a formatted test message.', 'created': '2000-01-01'}, {'user': {'username': 'internal', 'email': None, 'first_name': None, 'last_name': None}, 'course_run_key': None, 'comment': 'This is an internal user comment without formatting.', 'created': '2000-01-01'}]
